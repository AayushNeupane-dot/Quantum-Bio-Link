...
import string
import requests
from geopy.geocoders import Nominatim  # For getting user's location

app = Flask(__name__)
app.secret_key = '7894'

# Configure Gemini API
GEMINI_API_KEY = "AIzaSyBoqgLOxT8nwaYvDozbcw53akI5RK1fXt0"
...
GOMAPS_API_KEY = "your_gomaps_api_key"  # Replace with your actual GoMaps API key

def get_nearby_hospitals(severity, lat, lng):
    """Get nearby hospitals using GoMaps API"""
    try:
        # Base URL for GoMaps API
